...
/**
 * TsysRoleRightId generated by hbm2java
 */
public class TsysRoleRightId implements java.io.Serializable {
	...
	public TsysRoleRightId() {
	}

	public TsysRoleRightId(String transCode, String subTransCode,
			String roleCode, BigDecimal beginDate, BigDecimal endDate,
			String rightFlag) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TsysRoleRightId))
			return false;
		TsysRoleRightId castOther = (TsysRoleRightId) other;
