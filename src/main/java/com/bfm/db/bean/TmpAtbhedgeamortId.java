...
/**
 * TmpAtbhedgeamortId generated by hbm2java
 */
public class TmpAtbhedgeamortId implements java.io.Serializable {
	...
	public TmpAtbhedgeamortId() {
	}

	public TmpAtbhedgeamortId(String hsdate, String bookcode, String assetId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpAtbhedgeamortId))
			return false;
		TmpAtbhedgeamortId castOther = (TmpAtbhedgeamortId) other;
