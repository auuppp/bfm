...
/**
 * TmpAthisassetamorzsumId generated by hbm2java
 */
public class TmpAthisassetamorzsumId implements java.io.Serializable {
	...
	private BigDecimal assetOlamor;
	private BigDecimal amorDays;
	private Character genFlag;

	public TmpAthisassetamorzsumId() {
	}

	public TmpAthisassetamorzsumId(String hsdate, String transId,
			String bookcode, String assetId, String assetPort,
			String costsCenter, String assetType, String amorBdate,
			String amorEdate, String amorDate, char amorType) {
		this.hsdate = hsdate;
	...
	public TmpAthisassetamorzsumId(String hsdate, String transId,
			...
			String costsCenter, String assetType, String amorBdate,
			String amorEdate, String amorDate, char amorType,
			String bookBranch, String curCode, Character amorFlag,
			BigDecimal rate, BigDecimal amt, BigDecimal assetAmor,
			BigDecimal assetAlamor, BigDecimal assetBlamor,
			BigDecimal assetOlamor, BigDecimal amorDays, Character genFlag) {
		this.hsdate = hsdate;
		this.transId = transId;
		this.bookcode = bookcode;
		this.assetId = assetId;
	...
	public BigDecimal getAssetOlamor() {
		return this.assetOlamor;
	}

	public void setAssetOlamor(BigDecimal assetOlamor) {
		this.assetOlamor = assetOlamor;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpAthisassetamorzsumId))
			return false;
		TmpAthisassetamorzsumId castOther = (TmpAthisassetamorzsumId) other;
		...
		return ((this.getHsdate() == castOther.getHsdate()) || (this
				...
				&& ((this.getAssetOlamor() == castOther.getAssetOlamor()) || (this
						.getAssetOlamor() != null
						&& castOther.getAssetOlamor() != null && this
						.getAssetOlamor().equals(castOther.getAssetOlamor())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getAssetOlamor() == null ? 0 : this.getAssetOlamor()
						.hashCode());
		result = 37 * result
