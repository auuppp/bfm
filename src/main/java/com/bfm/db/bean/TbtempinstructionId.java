...
/**
 * TbtempinstructionId generated by hbm2java
 */
public class TbtempinstructionId implements java.io.Serializable {

	private String dailyInstructionNo;
	private BigDecimal indexDailyModify;

	public TbtempinstructionId() {
	}

	public TbtempinstructionId(String dailyInstructionNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbtempinstructionId))
			return false;
		TbtempinstructionId castOther = (TbtempinstructionId) other;
