...
/**
 * TbtempinstructionstockId generated by hbm2java
 */
public class TbtempinstructionstockId implements java.io.Serializable {

	private String dailyInstructionNo;
	private BigDecimal indexDailyModify;

	public TbtempinstructionstockId() {
	}

	public TbtempinstructionstockId(String dailyInstructionNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbtempinstructionstockId))
			return false;
		TbtempinstructionstockId castOther = (TbtempinstructionstockId) other;
