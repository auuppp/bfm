...
/**
 * TmpTbassetunitstockId generated by hbm2java
 */
public class TmpTbassetunitstockId implements java.io.Serializable {
	...
	public TmpTbassetunitstockId() {
	}

	public TmpTbassetunitstockId(BigDecimal transDate, String fundNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpTbassetunitstockId))
			return false;
		TmpTbassetunitstockId castOther = (TmpTbassetunitstockId) other;
