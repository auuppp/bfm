...
/**
 * TmpAtbassetamorzsumId generated by hbm2java
 */
public class TmpAtbassetamorzsumId implements java.io.Serializable {
	...
	public TmpAtbassetamorzsumId() {
	}

	public TmpAtbassetamorzsumId(String transId, String bookcode,
			String assetId, String assetPort, String costsCenter,
			String assetType, String amorBdate, String amorEdate,
			String amorDate, char amorType) {
	...
	public TmpAtbassetamorzsumId(String transId, String bookcode,
			String assetId, String assetPort, String costsCenter,
			String assetType, String amorBdate, String amorEdate,
			String amorDate, char amorType, String bookBranch, String curCode,
			...
			BigDecimal assetOlamor, Character genFlag) {
		this.transId = transId;
		this.bookcode = bookcode;
		this.assetId = assetId;
		this.assetPort = assetPort;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpAtbassetamorzsumId))
			return false;
		TmpAtbassetamorzsumId castOther = (TmpAtbassetamorzsumId) other;
