...
/**
 * TbtempinstrhgmortagageId generated by hbm2java
 */
public class TbtempinstrhgmortagageId implements java.io.Serializable {
	...
	public TbtempinstrhgmortagageId() {
	}

	public TbtempinstrhgmortagageId(String dailyInstructionNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TbtempinstrhgmortagageId))
			return false;
		TbtempinstrhgmortagageId castOther = (TbtempinstrhgmortagageId) other;
