...
/**
 * TmpAtbfairpricesumId generated by hbm2java
 */
public class TmpAtbfairpricesumId implements java.io.Serializable {
	...
	public TmpAtbfairpricesumId() {
	}

	public TmpAtbfairpricesumId(String transId, String bookcode,
			String assetId, String costsCenter, String accType) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpAtbfairpricesumId))
			return false;
		TmpAtbfairpricesumId castOther = (TmpAtbfairpricesumId) other;
